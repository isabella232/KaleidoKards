        ...
        return (
            <div className="overlay">
                ...
                <h2 className="top-text"> Welcome to the KaleidoKards Trading Application</h2>
                    ...
                    <div className="purchase-and-trade-containers">
                        <PurchaseAction/>
                    <div className="informal-text-container">
                        <h2 className="informal-text">Packs are priced at 25 Ether for standard and 50 Ether for Platinum. All packs contain three unique cards.</h2>
                    ...
                    <TradeAction/>
                    <div className="informal-text-container">
                        <h2 className="informal-text-right">After purchasing, you have the ability to propose trades with Joe.  Drag a card from each user's collection and click the <b>`Propose Trade`</b> Button.</h2>
